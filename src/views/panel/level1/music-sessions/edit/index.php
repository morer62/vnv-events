...
$router->get(function () {
    ...
    if (!$id) {
        ...
        LocationUtils::redirectInternal("panel/music-sessions");
    }
...
$router->post(function () {
    ...
    if ($sessionRepo->update($data, ["id" => $id])) {
        ...
        MessageUtil::setMessage("Music session updated successfully.");
        LocationUtils::redirectInternal("panel/music-sessions");
    } else {
        MessageUtil::setMessage("Error updating music session. Please try again.");
        LocationUtils::reload();
    }
});
